...
<head>
<meta charset="UTF-8">
<title>Formulario CFE SEIEM</title>
...
<div class="form-container">
    <div class="form-box">
        ...
        <h2>Proyecto "Internet para Todos - CFE 4G</h2>
        ...
        <?php else: ?>
            <form id="formulario_unete" method="post" action="guardar_respuestas.php">
                <input type="hidden" name="formulario" value="CFE">
